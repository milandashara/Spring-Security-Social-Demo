...
<c:otherwise>
<c:out value="${securityLevel}" /></p><p> <a href="/spring-social-security-demo-webapp/" >Home</a>
</c:otherwise>
</c:choose>
</p>

                    <authz:authorize access="!hasRole('ROLE_USER')">
						<p>You are not logged in. &nbsp;<a href="/spring-social-security-demo-webapp/oauthlogin.jsp" />Login</a></p>
                    </authz:authorize>
                                  <authz:authorize access="hasRole('ROLE_USER')">
						You are logged in locally as <c:out value="${userName}" />. &nbsp;<a href="/spring-social-security-demo-webapp/logout">Logout</a></p>
                    ...
                    <authz:authorize access="hasRole('ROLE_USER') and !hasRole('ROLE_USER_FACEBOOK')">
						<p><a href="/spring-social-security-demo-webapp/oauthconnect.jsp">Connect</a> your account with Facebook</p>
                    </authz:authorize>
                    <authz:authorize access="hasRole('ROLE_USER') and !hasRole('ROLE_USER_TWITTER')">
						<p><a href="/spring-social-security-demo-webapp/oauthconnect.jsp">Connect</a> your account with Twitter</p>
                    </authz:authorize>
