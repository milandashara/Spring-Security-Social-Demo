...
<authz:authorize access="!hasRole('ROLE_USER_FACEBOOK')">
  ...
  <form class="login" action="/spring-social-security-demo-webapp/connect/facebook" method="POST">
...
<authz:authorize access="!hasRole('ROLE_USER_TWITTER')">
 ...
 <form class="login"action="/spring-social-security-demo-webapp/connect/twitter" method="POST">
